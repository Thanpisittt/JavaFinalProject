...
public class randomfood {
	 ...
	 private  String[] foodItems_nonhalal_B_Protine = {"โจ๊กหมู", "ข้าวต้มอกไก่", "หมูปิ้งไร้มัน", "ปลาท่องโก๋ นมจืด1แก้ว", "ขนมปังอกไข่พริกไทยดำ","แซนวิชหมูหยอง นมจืด1แก้ว"};//มื้อเช้าแบบโปรตีน
	 ...
	 private  String[] foodItems_halal_B_Protein = {"โจ๊กอกไก่", "ข้าวต้มปลา", "ปลาท่องโก๋ นมจืด", "ข้าวไข่เจียวอกไก่ทรงเครื่อง", "ไก่หยองข้าวเหนียว"};//มื้อเช้าฮาลาโปรตีนแน่นๆ
	...
	//มื้อเย็นไม่ควรกินเพื่มสารอาหารมากนักอาจจทำให้ต้องเผาผลานเยอะและถ้าเผาไม่หมดจะไปเก็บเป็นไขมันสะสมในร่างกายแทน
	 ...
	 public  String getRandomFoodnonhalal_B_Protein() {                                                     
		    Random random = new Random();
		    int index = random.nextInt(foodItems_nonhalal_B_Protine.length);
		    return foodItems_nonhalal_B_Protine[index];
		  }
